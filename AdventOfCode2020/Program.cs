...
WriteLine("-~*-*-*^~*~ Day 16 ~*~^*-*-*~-");
WriteLine($"The ticket scanning error rate is {AdventOfCode2020.Code.Day16.Part1.Solve()}");
WriteLine($"Multiplying those six values together gets us {AdventOfCode2020.Code.Day16.Part2.Solve()}");